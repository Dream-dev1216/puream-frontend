<template>
  <div>
    <v-card class="pa-1 mx-2 mt-6">
      <v-card-title class="justify-center display-1 mb-2">Due Diligence Login</v-card-title>
      <v-card-subtitle class="text-center">Need a PURE due diligence login? Submit a request</v-card-subtitle>
